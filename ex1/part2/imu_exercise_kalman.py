...
bias_gyro_x = 0.07529136114651137 # [rad/measurement]
bias_gyro_y = 0.04171717612625629 # [rad/measurement]
bias_gyro_z = 0.0008089498350258645 # [rad/measurement]
...
for line in f:
	...
	K=predVar/(predVar+updateVar)
	corrAngle=predAngle+K*(updateAngle-predAngle)
	corrVar = predVar*(1-K)
	estAngle = corrAngle
	estVar = corrVar
	gyroVarAcc = 0
